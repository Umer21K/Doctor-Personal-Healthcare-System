...
class _DiagnosisPageState extends State<DiagnosisPage> {
  ...
  // Function to fetch diagnoses records
  Future<void> _fetchDiagnoses() async {
    ...
    try {
      ...
      final result = await service.fetchDiagnoses(
  ...
  Widget _buildDataTable() {
    ...
    if (diagnoses.first is String) {
      return Center(child: Text(diagnoses.first));
    }

    final columns = (diagnoses.first as Map<String, dynamic>).keys.toList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Diagnosis Records'),
        centerTitle: true,
      ),
      body: Padding(
